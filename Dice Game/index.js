...
var randomImageSource = "images/" + randomDiceImage; //extracting the image source for Dice #1
...
var randomDiceImage = "dice" + randomNumber2 + ".png"; //creating the image file-name for Dice #2
